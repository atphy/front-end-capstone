  ...
  render() {
    return (
        <div className="single-instance-box">
            ...
            <p className="instance-start-dates">{this.state.singleInstance.startDate} to {this.state.singleInstance.endDate}</p><br></br>
            <p className="instance-notes">{this.state.singleInstance.userNotes}</p>
